...
const Welcome = () => {
    return (
        <div className="min-h-screen bg-gradient-to-b from-sky-300 to-green-300 flex flex-col items-center justify-center p-8 text-center overflow-hidden relative">
            ...
            <div className="z-10 bg-white/80 backdrop-blur-md p-10 rounded-3xl shadow-2xl border-4 border-white max-w-4xl w-full">
                ...
                <div className="flex justify-center items-end gap-4 mb-12 h-64">
                    <img src={leoImg} alt="Leo" className="h-48 md:h-64 hover:scale-110 transition duration-300" />
                    <img src={miaImg} alt="Mia" className="h-48 md:h-64 hover:scale-110 transition duration-300 delay-75" />
                    <img src={ivyImg} alt="Ivy" className="h-48 md:h-64 hover:scale-110 transition duration-300 delay-150" />
                    <img src={samImg} alt="Sam" className="h-48 md:h-64 hover:scale-110 transition duration-300 delay-200" />
                </div>
